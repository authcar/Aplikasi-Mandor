...
// Laporan harian dari SEMUA proyek (semua Supervisor) — Finance tidak perlu
// buka satu-satu halaman detail proyek untuk lihat laporan yang masuk.
export default async function LaporanHarianFinancePage() {
  ...
  // Tandai laporan baru sudah dilihat Finance supaya badge di dashboard hilang.
