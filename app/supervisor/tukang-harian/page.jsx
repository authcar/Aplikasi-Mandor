...
export default async function TukangHarianSupervisorPage() {
  ...
  return (
    <main className="p-4 pb-8">
      ...
      <header className="mb-4">
        ...
        <p className="text-sm text-gray-500">Kelola akun login tukang harian di semua proyek kamu</p>
      </header>
      ...
      {proyekList?.length ? (
        ...
        <div className="card p-6 text-center text-sm text-gray-400">
          Belum ada proyek aktif. Buat proyek dulu.
        </div>
      )}
    </main>
  );
