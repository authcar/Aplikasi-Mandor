...
// Sama dengan app/mandor/masalah/MasalahForm.jsx — laporan Kurang Material
// dari Supervisor sendiri. Notifikasinya (lihat app/api/notify) otomatis
// dialihkan ke Master, bukan ke Supervisor proyek (dirinya sendiri).
export default function MasalahForm({ proyeks = [], laporan = [] }) {
  ...
  return (
    <main className="p-4 pb-10">
      ...
      <BackButton href="/supervisor/masalah" />
