  ...
  return (
    <main className="flex min-h-dvh flex-col p-4 gap-3">
      ...
      {(proyekBelumAbsen.length > 0 || proyekBelumLapor.length > 0 || proyekTanpaMandor.length > 0) && (
        <div className="card shrink-0 divide-y divide-gray-100">
          {proyekBelumAbsen.length > 0 && (
            <Link href="/master/absensi" className="flex items-center justify-between gap-2 px-3.5 py-3 active:bg-gray-50">
          ...
          {proyekBelumLapor.length > 0 && (
            <Link href="/master/laporan-harian" className="flex items-center justify-between gap-2 px-3.5 py-3 active:bg-gray-50">
      ...
      <div className="shrink-0 grid grid-cols-2 gap-2">
        ...
        <Link href="/master/biaya-proyek" className="card-tap flex flex-col items-center justify-center gap-1 p-3">
