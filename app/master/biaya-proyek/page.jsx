...
// Ringkasan biaya & penerimaan TIAP proyek, dilihat Master (read-only —
// input biaya/penerimaan tetap eksklusif role FINANCE, lihat
// app/finance/proyek/[id]/biaya). Tap satu proyek untuk lihat rincian
// per pos & riwayatnya di app/master/proyek/[id]/biaya.
export default async function BiayaProyekMasterPage() {
  ...
  return (
    <main className="p-4 pb-8">
      ...
      <header className="mb-4">
        ...
        <p className="text-sm text-gray-500">Ringkasan biaya & penerimaan tiap proyek (dikelola Finance)</p>
      </header>
